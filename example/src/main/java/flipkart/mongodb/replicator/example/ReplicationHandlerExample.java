 ...
 */
public class ReplicationHandlerExample implements IReplicationHandler {

    @Override
    public void replicate(ReplicationEvent replicationEvent) throws MongoReplicatorException {
        System.out.println("op:" + replicationEvent.operation + ",ns:" + replicationEvent.namespace + ",ts:" + replicationEvent.v );
    }
}
